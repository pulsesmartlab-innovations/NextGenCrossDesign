...
test_that("robust allocation returns a robust plan alongside the standard plan", {
  ...
  cfgj <- list(schema = "ng_run_config.v1",
    ...
    trait_value_metric = "pmv", progeny = "DH", assume_inbred = TRUE,
    duplicate_action = "none",
    run_posterior_prediction = TRUE, posterior_method = "closed_form", nIter = 12, burnIn = 4,
    n_crosses = 7, max_uses_per_parent = 4, optimizer = "greedy_local",
