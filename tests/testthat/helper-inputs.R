...
demo_inputs <- function(...) {
  base <- list(
    ...
    local_iter = 2000, ocs_iter = 5, parallel_cores = NA, alphamate_n_threads = 1,
    ...
    progeny = "DH", recombination_model = "haldane", grm_method = "vanraden",
    ...
    n_crosses = 10, max_uses_per_parent = 4, min_unique_parents = NA, max_pair_kinship = NA,
    ...
    run_posterior_prediction = FALSE, posterior_method = "mcmc", nIter = 5000, burnIn = 500, use_parallel = FALSE,
