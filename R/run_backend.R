...
ngcd_error_hint <- function(msg) {
  ...
  if (grepl("residual-heterozygosity|heterozygous|assume_inbred|inbred|parent_type", msg))
    return("One or more parents carry heterozygous loci. A doubled-haploid / fully-inbred line must be homozygous (0/2 dosages) - fix or exclude those parents. If they are RILs, set Parent type to 'RIL' on Prediction & scoring to proceed.")
