    ...
    bslib::page_navbar(theme = theme, fillable = FALSE, id = "nav", padding = "16px",
        ...
        bslib::layout_columns(col_widths = c(6, 6),
          bslib::card(bslib::card_header("Merit metric"),
            shiny::selectInput("trait_value_metric", "Trait value metric",
              ngcd_control_choices(cfg$backend_registry, "trait_value_metric", c("var_complex","usefulness","pmv","vpm","mean","parent_distance")), selected = "var_complex"),
            shiny::div(class = "help-hint", "Recommended: var_complex. 'mean' for polygenic/small training. 'parent_distance' is a genetic-distance screening proxy, not merit."),
            shiny::selectInput("uc_variance_source", "UC variance source", ngcd_control_choices(cfg$backend_registry, "uc_variance_source", c("pmv","vpm","parent_distance"))),
            shiny::selectInput("method_varPMV", "PMV method", ngcd_control_choices(cfg$backend_registry, "method_varPMV", c("fast","full_posterior"))),
      ...
      bslib::nav_panel("Advanced",
        ...
        bslib::accordion(open = FALSE,
          bslib::accordion_panel("Mate relatedness (per-cross)",
            shiny::div(class = "help-hint",
