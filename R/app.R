        ...
        bslib::layout_columns(col_widths = c(6, 6),
          bslib::card(bslib::card_header("Merit metric"),
            shiny::selectInput("trait_value_metric", "Trait value metric",
              ngcd_control_choices(cfg$backend_registry, "trait_value_metric", c("var_complex","usefulness","pmv","vpm","mean","le")), selected = "var_complex"),
            shiny::div(class = "help-hint", "Recommended: var_complex. 'mean' for polygenic/small training. 'var_simple' is diversity, not merit."),
            shiny::selectInput("uc_variance_source", "UC variance source", ngcd_control_choices(cfg$backend_registry, "uc_variance_source", c("pmv","vpm","le"))),
