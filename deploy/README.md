...
```
ghcr.io/pulsesmartlab-innovations/ngcd-workbench:0.26.0   # (also :latest)
```
...
docker buildx build --builder ngcd-builder \
  ...
  -t ghcr.io/pulsesmartlab-innovations/ngcd-workbench:0.26.0 \
